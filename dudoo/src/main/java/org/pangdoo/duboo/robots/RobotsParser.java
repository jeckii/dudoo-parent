...
public class RobotsParser {
	...
	private final static LogLogger logger = LogLogger.getLogger(RobotsParser.class);
	
	private byte[] bytes;
	private String charsetName;
	
	public RobotsParser(InputStream input, String charsetName) throws IOException {
		int toIndex = 0;
		int index = 0;
